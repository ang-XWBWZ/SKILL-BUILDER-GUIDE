...
**完整模板位置**: `skills/example-delegation/SKILL.md`

**核心特点**:

| 特点 | 说明 |
|------|------|
| L0 强制下放 | 文件查找、信息查阅、命令执行必须派 Haiku |
| 标准调用格式 | Agent(model: "haiku") 的统一 prompt 模板 |
| 输出规范 | Conclusion/Basis/Uncertainty 三要素格式 |

**详细规则**：见[第十五章 分治驱动层技能](#十五分治驱动层技能)。
